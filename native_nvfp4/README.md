...
scripts/run-isolated.ps1 -Executable $python -TimeoutSeconds 1200 `
  -CompletionMarker 'DENSE_FULL_MODEL_REGISTRY_PASS' `
  -CommandLine '-3 native_nvfp4/bench_dense_full_model.py --gates 16,32,48,56,60,64 --max-tokens 32768 --kv-dtype bf16 --warmups 2 --samples 10'
...
# All 256 experts resident; top-8 selection and dispatch remain on device
scripts/run-isolated.ps1 -Executable $python -TimeoutSeconds 300 `
